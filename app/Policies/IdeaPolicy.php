...
final class IdeaPolicy
{
    ...
    {
        return $user->checkPermissionTo('view-any Idea');
    }
    ...
    {
        return $user->checkPermissionTo('create Idea');
    }
    ...
    {
        return $user->checkPermissionTo('delete-any Idea');
    }
    ...
    {
        return $user->checkPermissionTo('restore-any Idea');
    }
    ...
    {
        return $user->checkPermissionTo('reorder Idea');
    }
    ...
    {
        return $user->checkPermissionTo('force-delete-any Idea');
    }
}
