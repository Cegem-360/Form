<div class="px-8 pt-8">
    <h2 class="mb-6 text-2xl font-semibold text-sky-500">Pénzügyi, vállalási feltételek</h2>
    <div class="grid grid-cols-[180px_1fr] gap-x-6 gap-y-4 text-[17px]">
        ...
        <div class="font-bold">Fizetési határidő</div>
        <div>A számla keltétől számított 5 naptári napon belül. A díj azon a napon számít megfizetettnek, amikor az
            összeg bankszámlánkon jóváírásra kerül.</div>
        <div class="font-bold">Előleg</div>
        <div>Az előlegre vonatkozóan szeretnénk tájékoztatni, hogy a projekt megkezdése előtt 50%-os előleget kérünk a
            teljes összegből (kivéve az opcionális költségek, azok a projekt átadása után kerülnek elszámolásra). Az
            előleg fizetése lehetőséget nyújt számunkra, hogy a projekt kezdetén a szükséges erőforrásokat biztosítani
            tudjuk, és a munkát azonnal elkezdhessük.</div>
