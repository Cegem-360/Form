...
<html lang="hu">
    ...
    <body>
        ...
        <ul>
            ...
            <li><span class="label">Létrehozva</span> <span
                    class="value">{{ $formQuestion->created_at->format('Y. m. d. H:i') }}</span></li>
            <li><span class="label">Utoljára módosítva</span> <span
                    class="value">{{ $formQuestion->updated_at->format('Y. m. d. H:i') }}</span></li>
        ...
        <ul>
            ...
            <li><span class="label">Kapcsolattartó neve</span> <span
                    class="value">{{ $formQuestion->contact_name }}</span></li>
            <li><span class="label">Kapcsolattartó email</span> <span
                    class="value">{{ $formQuestion->contact_email }}</span></li>
            <li><span class="label">Kapcsolattartó telefon</span> <span
                    class="value">{{ $formQuestion->contact_phone }}</span></li>
            <li><span class="label">Kapcsolattartó pozíció</span> <span
                    class="value">{{ $formQuestion->contact_positsion }}</span></li>
        ...
        <ul>
            <li><span class="label">Van meglévő weboldal</span>
                <span
                    class="{{ $formQuestion->have_exist_website ? 'boolean-yes' : 'boolean-no' }}">{{ $formQuestion->have_exist_website ? 'Igen' : 'Nem' }}</span>
            </li>
            ...
            <li><span class="label">Pontos határidő</span>
                <span
                    class="{{ $formQuestion->is_exact_deadline ? 'boolean-yes' : 'boolean-no' }}">{{ $formQuestion->is_exact_deadline ? 'Igen' : 'Nem' }}</span>
            </li>
        ...
        <ul>
            <li><span class="label">Van meglévő dizájn</span>
                <span
                    class="{{ $formQuestion->have_exist_design ? 'boolean-yes' : 'boolean-no' }}">{{ $formQuestion->have_exist_design ? 'Igen' : 'Nem' }}</span>
            </li>
        ...
        <ul>
            <li><span class="label">Videó vagy animáció használata</span>
                <span
                    class="{{ $formQuestion->use_video_or_animation ? 'boolean-yes' : 'boolean-no' }}">{{ $formQuestion->use_video_or_animation ? 'Igen' : 'Nem' }}</span>
            </li>
            ...
            <li><span class="label">Oldalak</span>
        ...
        <ul>
            <li><span class="label">Van termék katalógus</span>
                <span
                    class="{{ $formQuestion->have_product_catalog ? 'boolean-yes' : 'boolean-no' }}">{{ $formQuestion->have_product_catalog ? 'Igen' : 'Nem' }}</span>
            </li>
        ...
        <ul>
            <li><span class="label">Többnyelvű oldal</span>
                <span
                    class="{{ $formQuestion->need_multi_language ? 'boolean-yes' : 'boolean-no' }}">{{ $formQuestion->need_multi_language ? 'Igen' : 'Nem' }}</span>
            </li>
        ...
        <ul>
            <li><span class="label">Blog</span>
                <span
                    class="{{ $formQuestion->have_blog ? 'boolean-yes' : 'boolean-no' }}">{{ $formQuestion->have_blog ? 'Igen' : 'Nem' }}</span>
            </li>
            ...
            <li><span class="label">SEO fontossága</span>
                <span
                    class="{{ $formQuestion->importance_of_seo ? 'boolean-yes' : 'boolean-no' }}">{{ $formQuestion->importance_of_seo ? 'Igen' : 'Nem' }}</span>
            </li>
            <li><span class="label">Fizetett hirdetés</span>
                <span
                    class="{{ $formQuestion->have_payed_advertising ? 'boolean-yes' : 'boolean-no' }}">{{ $formQuestion->have_payed_advertising ? 'Igen' : 'Nem' }}</span>
            </li>
        ...
        <ul>
            <li><span class="label">Van szerződött könyvelő</span>
                <span
                    class="{{ $formQuestion->have_contracted_accountant ? 'boolean-yes' : 'boolean-no' }}">{{ $formQuestion->have_contracted_accountant ? 'Igen' : 'Nem' }}</span>
            </li>
            ...
            <li><span class="label">Van szerződött online bankkártya fizetés</span>
                <span
                    class="{{ $formQuestion->have_contracted_online_bank_card_payment ? 'boolean-yes' : 'boolean-no' }}">{{ $formQuestion->have_contracted_online_bank_card_payment ? 'Igen' : 'Nem' }}</span>
            </li>
